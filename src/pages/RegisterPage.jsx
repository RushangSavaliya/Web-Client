        ...
        <section className="w-full max-w-lg md:max-w-xl mx-auto">
          ...
          >
            ...
            <label className="floating-label validator w-full">
              ...
              />
              <span>Username</span>
              {errors.username && <p className="validator-hint">{errors.username}</p>}
            </label>
            ...
            <label className="floating-label validator w-full">
              ...
              />
              <span>Email</span>
              {errors.email && <p className="validator-hint">{errors.email}</p>}
            </label>
            ...
            <label className="floating-label validator w-full relative">
              ...
              {errors.password && <p className="validator-hint">{errors.password}</p>}
            </label>
            ...
            >
              {loading ? <div className="loading-spinner w-4 h-4" /> : "Register"}
            </button>
